...
def detect_color_in_video(color_ranges):
    ...
    while True:
        ...
        if color_counts[predominant_color] == 0:
            print("No se ha detectado ningún color especificado")
        else:
            print(f"El color predominante es: {predominant_color}")
...
if __name__ == "__main__":
    ...
    color_ranges = {
        ...
        "Verde": (np.array([50, 100, 100]), np.array([85, 255, 255]))  # Ajustar este rango según sea necesario
    }
